...
if(!class_exists( 'STAdmin' )) {
    ...
    class STAdmin
    {
        ...
        function update_location_info( $post_id )
        {
            ...
            if($post_type == 'st_cars' or $post_type == 'st_activity' or $post_type == 'st_tours' or $post_type == 'st_holidays' or $post_type == 'st_rental' or $post_type == 'st_hotel') {
