...
if(!class_exists('STAdminPermalink')) {
    ...
    class STAdminPermalink extends STAdmin
    {
        ...
        public function settings() {
            ...
            $holiday_permalink = get_option( 'holiday_permalink' ,'st_holiday' );
            ?>
            <table class="form-table">
                ...
                <tr>
                    <th><label><?php _e( 'Holiday Custom Base', ST_TEXTDOMAIN ); ?></label></th>
                    <td>
                        <input name="holiday_permalink" type="text" value="<?php echo esc_attr( $holiday_permalink ); ?>" class="regular-text code">
                    </td>
                </tr>
                <tr>
        ...
        public function settings_save() {
            ...
            if ( isset( $_POST['hotel_permalink'] )
                ...
                update_option( 'holiday_permalink', $_POST['holiday_permalink'] );
