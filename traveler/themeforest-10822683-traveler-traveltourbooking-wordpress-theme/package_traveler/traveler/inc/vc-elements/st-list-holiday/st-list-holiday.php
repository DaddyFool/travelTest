...
if(function_exists( 'vc_map' ) and class_exists('TravelerObject')) {
    ...
    $params  = array(
        ...
        array(
            "type"        => "textfield" ,
            "holder"      => "div" ,
            "heading"     => __( "List ID in Holiday" , ST_TEXTDOMAIN ) ,
            "param_name"  => "st_ids" ,
        ...
        array(
            "type"        => "textfield" ,
            "holder"      => "div" ,
            "heading"     => __( "Number holiday" , ST_TEXTDOMAIN ) ,
            "param_name"  => "st_number_holiday" ,
            "description" => "" ,
            'value'       => 4 ,
        ) ,
        array(
        ...
        array(
            "type"        => "dropdown" ,
            "holder"      => "div" ,
            "heading"     => __( "Style Holiday" , ST_TEXTDOMAIN ) ,
            "param_name"  => "st_style" ,
            "description" => "" ,
            'value'       => array(
                __('--Select--',ST_TEXTDOMAIN)=>'',
    ...
    vc_map( array(
        "name"            => __( "ST List Holiday" , ST_TEXTDOMAIN ) ,
        "base"            => "st_list_holiday" ,
...
if(!function_exists( 'st_vc_list_holiday' )) {
    function st_vc_list_holiday( $attr , $content = false )
    {
        ...
        $query = array(
            ...
            'posts_per_page' => $st_number_holiday ,
            'paged'          => $page ,
            'order'          => $st_order ,
            'orderby'        => $st_orderby
        );
...
if(st_check_service_available( 'st_holidays' )) {
    st_reg_shortcode( 'st_list_holiday' , 'st_vc_list_holiday' );
}

if(!class_exists('st_list_holiday')){
    class st_list_holiday{
