...
$detail_holiday_layout=apply_filters('st_holidays_detail_layout',st()->get_option('holidays_layout'));
if(get_post_meta($detail_holiday_layout , 'is_breadcrumb' , true) !=='off'){
    get_template_part('breadcrumb');
}
$layout_class = get_post_meta($detail_holiday_layout , 'layout_size' , true);
...
<div class="<?php echo balanceTags($layout_class) ; ?>">
    <div class="booking-item-details no-border-top">
        <header class="booking-item-header">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="lh1em featured_single featured_single_holiday">
                    ...
                    <ul class="list list-inline text-small">
                        ...
                        <li><a href="mailto:<?php echo esc_url($email)?>"><i class="fa fa-envelope"></i> <?php st_the_language('holiday_email')?></a>
                        </li>
                        <?php endif;?>
                        <?php if($website=get_post_meta(get_the_ID(),'website',true)):?>
                            <li><a target="_blank" href="<?php echo esc_url( $website )?>"> <i class="fa fa-home"></i> <?php st_the_language('holiday_website')?></a>
                            </li>
                        <?php endif;?>
