<?php
    ...
    if ( 'vc_holiday' == $this->shortcode ) $element = 'wpb_holiday';
// Extract tab titles
    ...
    if($tab_style == "single_tab"){
        ...
        $output .= "\n\t\t" . '<div class="wpb_wrapper wpb_holiday_tabs_wrapper ui-tabs vc_clearfix">';
        ...
        if ( 'vc_holiday' == $this->shortcode ) {
            $output .= "\n\t\t\t" . '<div class="wpb_holiday_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'js_composer' ) . '">' . __( 'Previous tab', 'js_composer' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'js_composer' ) . '">' . __( 'Next tab', 'js_composer' ) . '</a></span></div>';
        }
