...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="panel panel-primary panel-st_holidays panel-single">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-3">
                        <i class="fa <?php echo apply_filters('st_post_type_st_holidays_icon','') ?> fa-5x"></i>
                    </div>
                    <div class="col-xs-9 text-right">
                        <div class="huge">
                            <?php
                            $price = $this_data_custom['post_type']['st_holidays']['average_total'];
                            if(empty($price)){
                                echo esc_html($price);
                            }else{
                                echo TravelHelper::format_money($price);
                        ...
                        <div class="title"><?php _e("Holiday",ST_TEXTDOMAIN) ?></div>
                    </div>
                </div>
            </div>
            <a href="<?php echo  esc_url( add_query_arg( array('sc'=>'dashboard-info','type'=>'st_holidays') , get_the_permalink() ) ) ?>">
                <div class="panel-footer">
                    <span class="pull-left"><?php _e("View Details",ST_TEXTDOMAIN) ?></span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
