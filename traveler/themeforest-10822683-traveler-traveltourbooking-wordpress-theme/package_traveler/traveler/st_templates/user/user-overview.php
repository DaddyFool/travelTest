...
<ul class="list list-inline user-profile-statictics mb30">
    ...
    <?php foreach ($list_partner as $k => $v): ?>
        ...
        <?php endif; ?>
        <?php if ($v['id_partner'] == 'holiday'): ?>
            <li><i class="fa fa-flag-o user-profile-statictics-icon"></i>
                <h5><?php echo esc_html($data['st_holidays']) ?></h5>
                <p><?php if($data['st_holidays'] > 1)st_the_language('holidays');else st_the_language('holiday'); ?></p>
            </li>
        <?php endif; ?>
