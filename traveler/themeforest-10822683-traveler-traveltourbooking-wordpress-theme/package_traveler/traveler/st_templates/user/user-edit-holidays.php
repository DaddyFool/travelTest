...
?>
<div class="st-create">
    <h2 class="pull-left"><?php _e("Edit Holiday",ST_TEXTDOMAIN) ?></h2>
...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner">
    <?php wp_nonce_field('user_setting','st_update_post_holidays'); ?>
    <div class="form-group form-group-icon-left">
        
        <label for="title" class="head_bol"><?php echo __('Name of Holiday', ST_TEXTDOMAIN); ?>:</label>
        <i class="fa  fa-file-text input-icon input-icon-hightlight"></i>
        <input id="title" name="title" type="text" placeholder="<?php echo __('Name of Holiday', ST_TEXTDOMAIN); ?>" class="form-control" value="<?php echo esc_html($post->post_title) ?>">
        <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('title'),'danger') ?></div>
    </div>
    <div class="form-group form-group-icon-left">
        <label for="st_content" class="head_bol" ><?php st_the_language('user_create_holiday_content') ?>:</label>
    ...
    <div class="form-group">
        <label for="desc" class="head_bol"><?php _e("Holiday Description",ST_TEXTDOMAIN) ?>:</label>
    ...
    <div class="tabbable tabs_partner">
        <ul class="nav nav-tabs" id="">
            ...
            <?php endif ?>
            <?php $custom_field = st()->get_option( 'holidays_unlimited_custom_field' );
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-general">
                <div class="row">
                    <?php
                    $taxonomies = (get_object_taxonomies('st_holidays'));
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class='form-group form-group-icon-left'>
                            ...
                            <label for="st_custom_layout"><?php _e( "Detail Holiday Layout" , ST_TEXTDOMAIN ) ?>:</label>
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $layout = st_get_layout('st_holidays');
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="video"><?php st_the_language('user_create_holiday_video') ?>:</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <select id="type_price" name="type_price" class="form-control">
                                <option <?php /*if($type_price == 'holiday_price') echo 'selected="selected"'; */?> value="holiday_price"><?php /*_e("Price / Holiday",ST_TEXTDOMAIN )*/?></option>
                                <option <?php /*if($type_price == 'people_price') echo 'selected="selected"'; */?> value="people_price"><?php /*_e("Price / Person",ST_TEXTDOMAIN )*/?></option>
                            </select>
                            <div class="st_msg console_msg_holiday_type"></div>
                        </div>
                    </div>
                </div>-->
                <div class="row">
                    <!--<div class="holiday_price">
                        <div class="col-md-12">
                            <div class="form-group form-group-icon-left">
                                ...
                                <label><?php /*st_the_language('user_create_holiday_price') */?>:</label>
                                <i class="fa fa-money input-icon input-icon-hightlight"></i>
                                <input id="price" name="price" type="text" placeholder="<?php /*st_the_language('user_create_holiday_price') */?>" class="number form-control" value="<?php /*echo get_post_meta($post_id ,'price', true) */?>">
            ...
            <div class="tab-pane fade" id="tab-info">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="holiday_type"><?php _e("Holiday Type",ST_TEXTDOMAIN) ?>:</label>
                            <i class="fa  fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $holiday_type = get_post_meta($post_id,'holiday_type',true)?>
                            <select id="holiday_type" name="holiday_type" class="form-control">
                                <option  value="specific_date" <?php if($holiday_type == 'specific_date') echo 'selected'; ?>><?php _e("Specific Date",ST_TEXTDOMAIN )?></option>
                                <option  value="daily_holiday" <?php if($holiday_type == 'daily_holiday') echo 'selected'; ?>><?php _e("Daily Holiday",ST_TEXTDOMAIN )?></option>
                            </select>
                            <div class="st_msg console_msg_holiday_type"></div>
                        </div>
                    </div>
                    <div class="col-md-6 data_duration">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-star input-icon input-icon-hightlight"></i>
                            <input id="duration" name="duration" type="text" placeholder="<?php _e("Duration",ST_TEXTDOMAIN) ?>" class="duration form-control number" value="<?php echo STHoliday::get_duration_unit(($post_id)); ?>">
                ...
                <div class="row">
                    <div class='col-md-6'>
                        <div class="form-group">
                            <label for="holidays_booking_period"><?php _e("Booking Period",ST_TEXTDOMAIN) ?>:</label>
                            <input id="holidays_booking_period" name="holidays_booking_period" type="text" min="0" placeholder="<?php _e("Booking Period (day)",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo get_post_meta($post_id ,'holidays_booking_period', true) ?>">
                        </div>
                    </div>
                    <div class='col-md-6'>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="st_holiday_external_booking"><?php _e("External Booking",ST_TEXTDOMAIN) ?>:</label>
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $external_booking = get_post_meta($post_id ,'st_holiday_external_booking',true); ?>
                            <select class="form-control st_holiday_external_booking" name="st_holiday_external_booking" id="st_holiday_external_booking">
                    ...
                    <div class='col-md-6 data_st_holiday_external_booking'>
                        <div class="form-group form-group-icon-left">
                            
                            <label for="st_holiday_external_booking"><?php _e("External Booking URL",ST_TEXTDOMAIN) ?>:</label>
                            <i class="fa fa-link  input-icon input-icon-hightlight"></i>
                            <input id="st_holiday_external_booking_link" name="st_holiday_external_booking_link" type="text" placeholder="<?php _e("Eg: https://domain.com") ?>" class="form-control" value="<?php echo get_post_meta($post_id ,'st_holiday_external_booking_link', true) ?>">
                            <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('st_holiday_external_booking_link'),'danger') ?></div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-group-icon-left">
                            <label for="holiday_program"><?php _e("Holiday's Program",ST_TEXTDOMAIN) ?>:</label>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <?php $holidays_program = get_post_meta($post_id  ,'holidays_program',true); ?>
                    <div class=""  id="data_program">
                        <?php
                        if(!empty($holidays_program)){
                            foreach($holidays_program as $k=>$v){
                                ?>
                                <div class="item">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="program_title"><?php st_the_language('user_create_holiday_program_title') ?></label>
                                            <input id="title" name="program_title[]" type="text" class="form-control" value="<?php echo esc_html($v['title']) ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            <label for="program_desc"><?php st_the_language('user_create_holiday_program_desc') ?></label>
                    ...
                    <div class="col-md-8">
                        <div class="form-group form-group-icon-left">
                            <button id="btn_add_program" type="button" class="btn btn-info"><?php st_the_language('user_create_holiday_add_program') ?></button><br>
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane fade" id="availablility_tab">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <?php echo st()->load_template('availability/form-holiday'); ?>
                    </div>
                </div>
            </div> 
        </div>
    ...
    <div class="text-center div_btn_submit">
        <input  type="button" id="btn_check_insert_post_type_holidays"  class="btn btn-primary btn-lg" value="<?php _e("UPDATE TOUR",ST_TEXTDOMAIN) ?>">
        <input name="btn_update_post_type_holidays" id="btn_insert_post_type_holidays" type="submit"  class="btn btn-primary hidden" value="SUBMIT">
    </div>
</form>
<div id="html_program" style="display: none">
    <div class="item">
        <div class="col-md-4">
            <div class="form-group form-group-icon-left">
                <label for="title"><?php st_the_language('user_create_holiday_program_title') ?></label>
...
<script>
    jQuery(function($){
        ...
        if(type_price == 'holiday_price'){
            $('.holiday_price').show(500);
            $('.people_price').hide(500);
        }else{
            $('.holiday_price').hide(500);
