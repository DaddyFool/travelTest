 ...
 * @since 1.0
 *
 * Email booking information holiday
 *
...
$type_holiday  = get_post_meta( $order_code , 'type_holiday' , true );
$title_type_holiday = '';
if($type_holiday == 'specific_date')
    $title_type_holiday = __('Specific Date',ST_TEXTDOMAIN);
if($type_holiday == 'daily_activity')
    $title_type_holiday = __('Daily Activity',ST_TEXTDOMAIN);
                ...
                $i = 0;
                    ...
                    <tr>
                        ...
                        <td style="padding: 6px;vertical-align: top;border-bottom:1px dashed #ccc;border-left: 1px solid #bcbcbc;border-bottom: 1px solid #bcbcbc;border-right: 1px solid #bcbcbc;">
                            ...
                            <p>
                                <strong><?php _e( "Holiday Type:" , ST_TEXTDOMAIN ) ?></strong> 
                                <?php echo esc_html($title_type_holiday) ?>
                            </p>
