...
<tr>
    ...
    <td>
        ...
        <?php }?>
        <p><strong><?php st_the_language('booking_holiday') ?></strong> <?php  echo get_the_title($object_id)?></p>
        <?php if($max_people=get_post_meta($object_id,'max_people',true)){ ?>
        <p><strong><?php st_the_language('holiday_max_people') ?>: </strong> <?php echo $max_people ?> </p>
        <?php }?>
        <?php if($adult_number){?>
        ...
        if($type_holiday =='daily_holiday') { ?>
            <?php if($check_in){?>
                <p>
                    <strong><?php st_the_language('holiday_date') ?> : </strong>
            ...
            <?php } ?>
        <?php }
        else if($type_holiday =='specific_date'){?>
