<?php
    ...
    $allOrderby=$holidays->getOrderby();
...
<div class="row">
    <div class="col-md-12">
        ...
        <?php
            ...
            if($query->have_posts()) {
                while( $query->have_posts() ) {
                    ...
                    if($st_style == '1'){
                        $content .=st()->load_template('holidays/elements/loop/loop-1',null , array('holiday_id'=>get_the_ID(),"taxonomy"=>$taxonomy));
                    }
                    if($st_style == '2'){
                        $content .=  st()->load_template('holidays/elements/loop/loop-2',null, array('holiday_id'=>get_the_ID(),"taxonomy"=>$taxonomy));
                    }
                }
            }
            if($st_style == '1'){
        ...
        <div class="row" style="margin-bottom: 40px;">
            ...
            <div class="col-md-6">
                <p>
                    <small><?php echo balanceTags($holidays->get_result_string())?>. &nbsp;&nbsp;
                        <?php
            ...
            <div class="col-md-6 text-right">
                <p>
                    <?php st_the_language('holiday_not_what_you_looking_for') ?>
                    <a class="popup-text" href="#search-dialog" data-effect="mfp-zoom-out">
                        <?php st_the_language('holiday_try_your_search_again') ?>
                    </a>
                </p>
            </div>
        </div>
