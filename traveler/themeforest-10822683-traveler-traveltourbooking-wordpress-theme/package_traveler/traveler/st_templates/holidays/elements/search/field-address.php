...
<div class="form-group form-group-<?php echo esc_attr($field_size)?> form-group-icon-left">
    ...
    <label for="field-holiday-address"><?php echo esc_html( $title)?></label>
    ...
    <div class="st-select-wrapper">
        ...
        <select id="field-holiday-address" name="location_id" class="st-location-id st-hidden" placeholder="<?php if($placeholder) echo $placeholder; ?>" tabindex="-1">
            <option value=""></option>
            <?php 
