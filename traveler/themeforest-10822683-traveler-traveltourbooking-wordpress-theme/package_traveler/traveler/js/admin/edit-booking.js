...
(function($){
    ...
    $('select#type_tour').change(function(){
        ...
        {
            $('.type_tour_daily_tour').show();
            $('.type_tour_specific_date').hide();
        }else
        {
            $('.type_tour_daily_tour').hide();
    ...
    // Holiday Booking
    $('select#type_holiday').change(function(){

        if($(this).val()=='daily_holiday')
        {
            $('.type_holiday_daily_holiday').show();
            $('.type_holiday_specific_date').hide();
        }else
        {
            $('.type_holiday_daily_holiday').hide();
            $('.type_holiday_specific_date').show();
    ...
    $('select#type_price').change(function(){
        ...
        if($(this).val()=='holiday_price')
        {
            $('.type_price_holiday_price').show();
            $('.type_price_people_price').hide();
        }else
        {
            $('.type_price_holiday_price').hide();
            $('.type_price_people_price').show();
