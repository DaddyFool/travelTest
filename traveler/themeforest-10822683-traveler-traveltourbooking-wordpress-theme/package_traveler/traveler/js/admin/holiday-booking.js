jQuery(document).ready(function($) {
	...
	function getHolidayInfo(item_id){
		...
		if(typeof item_id != 'undefined' && parseInt(item_id) > 0){
			...
			$.post(ajaxurl, data, function(respon, textStatus, xhr) {
				...
				if(typeof respon == 'object'){
					$('#holiday-type-wrapper', $parent).html(respon.type_holiday);
                    ...
                    if(respon.holiday_text != 'daily_holiday'){
    ...
    $('#holiday_time').click(function(event) {
        /* Act on the event */
        return false;
    });
    $('#holiday_time').qtip({
