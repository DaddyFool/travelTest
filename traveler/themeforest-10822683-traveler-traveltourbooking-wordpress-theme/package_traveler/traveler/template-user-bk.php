                                                ...
                                                class="icon_partner fa fa-angle-right"></i></a>
                                                    <ul class="list user-profile-nav sub_partner" style="display: none">
                                                        <li <?php if ($sc == 'create-holidays') echo 'class="active"' ?>>
                                                            <a href="<?php echo esc_url(add_query_arg('sc', 'create-holidays')) ?>"><i
                                                                    class="fa fa-flag-o"></i><?php st_the_language('user_create_holiday') ?>
                                                            </a>
                                                        </li>
                                                        <li <?php if ($sc == 'my-holidays') echo 'class="active"' ?>>
                                                            <a href="<?php echo esc_url(add_query_arg('sc', 'my-holidays')) ?>"><i
                                                                    class="fa fa-flag-o"></i><?php st_the_language('user_my_holiday') ?>
                                                            </a>
                                                        </li>
                                                        <li <?php if ($sc == 'booking-holidays') echo 'class="active"' ?>>
                                                            <a href="<?php echo esc_url(add_query_arg('sc', 'booking-holidays')) ?>"><i class="fa fa-flag-o"></i><?php _e("Tour Bookings",ST_TEXTDOMAIN) ?>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                </li>        
