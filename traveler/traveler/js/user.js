jQuery(document).ready(function ($) {
    ...
    $('#btn_check_insert_post_type_holidays').click(function () {
        var dk = true;
        if (dk == true) {
            console.log('Submit create Holidays !');
            $('#btn_insert_post_type_holidays').click();
        }
    });
    ...
    check_show_hiden('st_holiday_external_booking', 'data_st_holiday_external_booking');
