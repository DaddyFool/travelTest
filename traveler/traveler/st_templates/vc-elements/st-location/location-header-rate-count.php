...
$count_holidays = STLocation::get_info_by_post_type(get_the_ID(), 'st_holidays') ; 
...
$count_rental = STLocation::get_info_by_post_type(get_the_ID(), 'st_rental');
	...
	$array_s = array(
	    ...
	    'st_holidays'=>array(
	            'count'=>$count_holidays['offers'],
	            "from"=>$count_holidays['min_max_price']['price_min'],
	            "item_has_min"=>$count_holidays['min_max_price']['detail']['item_has_min_price'],
	            'link' => add_query_arg(
	            	array('location_id'=>get_the_ID() , 's'=>'' , 'post_type'=>'st_holidays')  , home_url())
	            ),
	    'st_hotel'=>array(
