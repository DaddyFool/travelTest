...
<li <?php  post_class() ?>>
    ...
    <a rel="tooltip" data-original-title="<?php st_the_language('user_edit') ?>" href="<?php echo esc_url(add_query_arg(array('sc'=>'edit-holidays','id'=>get_the_ID()),get_the_permalink($page_my_account_dashboard))) ?>"  class="btn_remove_post_type cursor fa fa-edit booking-item-wishlist-remove" style="top:90px ; background: #ed8323 ; color: #fff"></a>
    ...
    <div <?php post_class('booking-item') ?>>
        <div class="row">
            ...
            <div class="col-md-3">
                <?php echo STHoliday::get_price_html(get_the_ID(),false,'<br>','booking-item-price'); ?>
