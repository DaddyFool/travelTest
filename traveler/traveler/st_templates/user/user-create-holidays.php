...
?>
<div class="st-create">
    <h2><?php _e("Add new Holiday",ST_TEXTDOMAIN) ?></h2>
</div>
<div class="msg">
...
<form action="" method="post" enctype="multipart/form-data" id="st_form_add_partner" class="<?php echo STUser_f::get_status_msg(); ?>">
    <?php wp_nonce_field('user_setting','st_insert_post_holidays'); ?>
    <div class="form-group form-group-icon-left">
        ...
        <input id="title" name="title" type="text" placeholder="<?php echo __('Name of Holiday', ST_TEXTDOMAIN); ?>" value="<?php echo STInput::request('title') ?>" class="form-control">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="tab-info">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa  fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $holiday_type = STInput::request('holiday_type')?>
                ...
                <div class="row">
                    <div class='col-md-6'>
                        <div class="form-group">
                            ...
                            <input id="holidays_booking_period" name="holidays_booking_period" type="text" min="0" placeholder="<?php _e("Booking Period (day)",ST_TEXTDOMAIN) ?>" class="form-control number" value="<?php echo STInput::request('holidays_booking_period',"0") ?>">
                            <div class="st_msg"><?php echo STUser_f::get_msg_html($validator->error('holidays_booking_period'),'danger') ?></div>
                        </div>
                    </div>
                    <div class='col-md-6'>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group form-group-icon-left">
                            ...
                            <i class="fa fa-cogs input-icon input-icon-hightlight"></i>
                            <?php $external_booking = STInput::request('st_holiday_external_booking') ?>
                    ...
                    <div class='col-md-6 data_st_holiday_external_booking'>
                        <div class="form-group form-group-icon-left">
                            ...
                            <label for="st_holiday_external_booking_link"><?php _e("External Booking URL",ST_TEXTDOMAIN) ?>:</label>
                            <i class="fa fa-link  input-icon input-icon-hightlight"></i>
                            <input id="st_holiday_external_booking_link" name="st_holiday_external_booking_link" type="text" placeholder="<?php _e("Eg: https://domain.com") ?>" class="form-control" value="<?php echo STInput::request('st_holiday_external_booking_link') ?>">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 div_btn_add_custom">
                        <div class="form-group form-group-icon-left">
                            <button id="btn_add_program" type="button" class="btn btn-info btn-sm"><?php st_the_language('user_create_holiday_add_program') ?></button><br>
                        </div>
                    </div>
                </div>
    ...
    <div class="text-center div_btn_submit">
        ...
        <input name="btn_insert_post_type_holidays" id="btn_insert_post_type_holidays" type="submit" disabled class="btn btn-primary btn-lg"  value="<?php _e("SUBMIT HOLIDAY",ST_TEXTDOMAIN) ?>">
    </div>
</form>
    ...
    <div class="item">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input id="title" name="program_title[]" type="text" class="form-control" placeholder="<?php st_the_language('user_create_holiday_program_title') ?>">
            </div>
        </div>
        <div class="col-md-7">
            <div class="form-group">
                <label for="program_desc"><?php st_the_language('user_create_holiday_program_desc') ?></label>
                <textarea name="program_desc[]" class="form-control " placeholder="<?php st_the_language('user_create_holiday_program_desc') ?>"></textarea>
            </div>
        </div>
        <div class="col-md-1">
            <div class="form-group form-group-icon-left">
