...
<div class="col-md-<?php echo esc_attr($col) ?> col-sm-6 col-xs-12 list_activity style_box">
    ...
    <div class="thumb">
        ...
        <div class="thumb-caption">
            ...
            <p class="mb0">
                <small>
                    <?php $info_book = STHoliday::get_count_book(get_the_ID());?>
            ...
            <div class="text-darken">
                <?php echo st()->load_template( 'holidays/elements/attribute' , 'list' ,array("taxonomy"=>$taxonomy));?>
            </div>
            <p class="mb0 text-darken">
                <?php echo STHoliday::get_price_html(get_the_ID()) ?>
            </p>
        </div>
    </div>
</div>
