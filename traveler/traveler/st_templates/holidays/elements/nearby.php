...
$nearby_posts=$holiday->get_near_by();
        ...
        <li <?php post_class('item-nearby')?>>
            ...
            <div class="booking-item booking-item-small">
                <div class="row">
                    ...
                    <div class="col-xs-4"><span class="booking-item-price-from"><?php st_the_language('holiday_from')?></span>
                       <span class="booking-item-price list_holiday_4">
                           <?php echo STHoliday::get_price_html(false,false,'-'); ?>
                       </span?>
<!--
