...
?>
<?php if(isset($data['type_holiday'])): ?>
<p class="booking-item-description"><span><?php echo __('Type holiday', ST_TEXTDOMAIN); ?>: </span><?php echo $data['type_holiday']; ?></p>
<?php endif; ?>

<?php if(isset($data['type_holiday']) && $data['type_holiday'] == 'daily_holiday'): ?>
...
<?php if(isset($data['type_holiday']) && $data['type_holiday'] == 'specific_date'): ?>
<p class="booking-item-description"><span><?php echo __('Departure date', ST_TEXTDOMAIN); ?>: </span><?php echo $data['check_in']; ?></p>
