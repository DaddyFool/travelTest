<?php
    if(!class_exists('st_widget_search_holiday')){
        class st_widget_search_holiday extends WP_Widget{

            public $cache_key='st_widget_search_holidays';

            public function __construct() {
                $widget_ops = array('classname' => 'st_widget_search_holidays', 'description' => __( "Holiday Filter Box",ST_TEXTDOMAIN) );
                parent::__construct('st_widget_search_holiday', __('ST Holiday Filter Box',ST_TEXTDOMAIN), $widget_ops);
            ...
            function add_scripts()
            {
                ...
                if($screen->base=='widgets'){
                    ...
                    wp_enqueue_script('search-holiday',get_template_directory_uri().'/js/admin/widgets/search-holidays.js',array('jquery','jquery-ui-sortable'),null,true);
                    wp_enqueue_style('search-holiday',get_template_directory_uri().'/css/admin/widgets/search-hotel.css',array('jquery-ui'));

                    wp_localize_script('search-holiday','st_search_holiday',array(
            ...
            public function widget($args, $instance) {
                ...
                echo st()->load_template('holidays/filter',null,array(
                    'instance'=>$instance
                ));
            ...
            function default_item($key=0,$old=array()){
                ...
                $tax=get_object_taxonomies('st_holidays','OBJECTS');
            ...
            public function form( $instance ) {
                ...
                <div class="st-search-fields">
                    ...
                    <a href="#" class="button st_add_field_holidays" onclick="return false;"><?php _e('Add New',ST_TEXTDOMAIN)?></a>
                    <a href="#" class="button st_save_fields_holidays" onclick="return false;"><?php _e('Save List',ST_TEXTDOMAIN)?></a>
                </div>
            <?php
            }
        }
        ...
        add_action( 'widgets_init', 'st_search_holiday_widget_register' );
    }
