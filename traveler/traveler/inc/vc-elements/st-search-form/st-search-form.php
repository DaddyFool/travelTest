<?php
    if(function_exists('vc_map')){
        vc_map( array(
            ...
            "base" => "st_search_form",
            "as_parent" => array(
                'only' => 'st_search_field_hotel,st_search_field_rental,st_search_field_car,st_search_field_tour,st_search_field_holiday,st_search_field_activity',
            ),
            ...
            'params'=>array(
                ...
                array(
                    ...
                    "value" => array(
                        ...
                        __( 'Holiday' , ST_TEXTDOMAIN )       => 'st_holidays' ,
        ...
        * */
        vc_map( array(
            "name" => __("ST Search Field Holiday", ST_TEXTDOMAIN),
            "base" => "st_search_field_holiday",
            "content_element" => true,
            "as_child" => array('only' => 'st_search_form'),
            "icon" => "icon-st",
            "params" => array(
                ...
                array(
                    ...
                    "param_name" => "st_select_field",
                    "description" => __("Select field",ST_TEXTDOMAIN),
                    "value" =>TravelHelper::st_get_field_search("st_holidays"),
                ),
                array(
                    "type" => "dropdown",
                    "heading" =>"Select taxonomy",
                    "param_name" => "st_select_taxonomy",
                    "description" => __("Select taxonomy",ST_TEXTDOMAIN),
                    "value" =>st_get_post_taxonomy('st_holidays',false),
                    'dependency' => array(
                        'element' => 'st_select_field',
                        'value' => array( 'taxonomy' )
                    ),
    ...
    if ( class_exists( 'WPBakeryShortCode' )and !class_exists('WPBakeryShortCode_st_search_field_holiday') ) {
        class WPBakeryShortCode_st_search_field_holiday extends WPBakeryShortCode {
            protected function content($arg, $content = null) {
                $data = shortcode_atts(array(
                    'st_title'=>'',
                    'st_col'=>"col-md-1",
                ...
                $text = '<div class="'.$st_col.'">
                            '.st()->load_template('holidays/elements/search/field-'.$st_select_field,false,array('data'=>$default,'field_size'=>'lg')).'
                        </div>';
                return $text;
            }
        }
