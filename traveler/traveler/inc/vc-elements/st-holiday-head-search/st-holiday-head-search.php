...
if(function_exists( 'vc_map' )) {
    vc_map( array(
        "name"            => __( "ST Sum of Holiday Search Results" , ST_TEXTDOMAIN ) ,
        "base"            => "st_search_holiday_title" ,
...
if(!function_exists( 'st_search_holiday_title' )) {
...
if(st_check_service_available( 'st_holidays' )) {
    st_reg_shortcode( 'st_search_holiday_title' , 'st_search_holiday_title' );
}