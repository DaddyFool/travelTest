    ...
    class TravelHelper{
            ...
            if(!empty($post_type)){
                switch($post_type){
                    ...
                    case "st_tours":
                        ...
                        break;
                    case "st_holidays":
                        $data_field = STHoliday::get_search_fields_name();
                        break;
                    case "st_activity":
        ...
        **/
        static function infoItemInLocation($post_id, $post_type = 'st_hotel'){
            ...
            }elseif($post_type == 'st_tours' || $post_type == 'st_holidays' || $post_type == 'st_activity'){
        ...
        **/
        ...
        static function get_all_post_type(){
            ...
            if (st_check_service_available('st_holidays')) { $post_type[] = "st_holidays"; }
        ...
        */
        ...
        static function st_admin_notice_post_draft(){
            $query = array(
                'post_status' => 'draft',
                'posts_per_page' => -1,
                'post_type' => array('st_hotel', 'st_rental', 'st_cars', 'st_tours', 'st_holidays', 'st_activity', 'hotel_room', 'rental_room')
            );
            $return = array();
            ...
            if(count($return)){
                ...
                foreach($return as $key => $item){
                    ...
                    if($key == 'st_holidays'){
                        $name = count($item) > 1 ? __('Holidays', ST_TEXTDOMAIN) : __('Holiday', ST_TEXTDOMAIN); 
                    }
                    if($key == 'st_activity'){
