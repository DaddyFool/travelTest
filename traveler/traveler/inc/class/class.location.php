        ...
        **/
        static function get_opt_list_std(){
            ...
            if (st_check_service_available('st_holidays')) {
                $array[] = array
                    (
                        'title' => __("Holiday" , ST_TEXTDOMAIN),
                        'tab_icon_' => "fa fa-flag-o",
                        'tab_type' => "st_holidays",
                    );
            }
            if (st_check_service_available('st_activity')) {
                $array[] = array
        ...
        {             
            ...
            if (!in_array($post_type , array('st_activity','st_hotel','st_rental' , 'st_cars' , 'st_tours' , 'st_holidays' , 'hotel_room'))){return;}
                    ...
                    $sql     = "
                        ...
                        AND soifjsf.ID IN (
                            ...
                            where (
                                ...
                                or {$wpdb->posts}.post_type = 'st_holidays'  
        ...
        static function get_list_post_type()
        {
            ...
            /*wp_localize_script('jquery','default_icon_gmap3_location' , array(
                ...
                'st_holidays'=>st()->get_option('st_holidays_icon_map_marker'),
